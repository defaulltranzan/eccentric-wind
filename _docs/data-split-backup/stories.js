...
(function () {
  ...
  STORIES['acclimatisation-philosophy'] = {
    ...
    destinations: ['everest', 'annapurna'],
    relatedTreks: ['everest-base-camp', 'annapurna-circuit'],
    editorsPick: true,
    body: [
  ...
  STORIES['crossing-the-thorong-la'] = {
    ...
    topics: ['trekking'],
    destinations: ['annapurna', 'mustang'],
    relatedTreks: ['annapurna-circuit'],
    featured: true,
    quickFacts: {
      duration: '12–16 days (full circuit)',
      difficulty: 'Challenging',
      maxElevation: '5,416 m — Thorong La',
      season: 'Mar–May · Sep–Nov',
      region: 'Annapurna, Gandaki',
      start: 'Besisahar / Chame'
    },
    body: [
  ...
  STORIES['a-morning-on-gokyo-ri'] = {
    ...
    topics: ['trekking', 'culture'],
    destinations: ['everest', 'gokyo'],
    relatedTreks: ['gokyo-lakes', 'three-passes'],
    body: [
  ...
  STORIES['choosing-your-first-himalayan-trek'] = {
    ...
    topics: ['planning', 'trekking'],
    destinations: ['everest', 'annapurna', 'langtang'],
    relatedTreks: ['everest-base-camp', 'annapurna-circuit', 'langtang-valley'],
    editorsPick: true,
    body: [
