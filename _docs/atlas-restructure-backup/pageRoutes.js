...
router.get('/expeditions/:band(8000m|7000m|6000m|trekking-peaks)', (req, res) => res.sendFile(path.join(PUBLIC_DIR, 'peaks-list.html')));
router.get('/expeditions/peaks', (req, res) => res.sendFile(path.join(PUBLIC_DIR, 'peaks-list.html')));
